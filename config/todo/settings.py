...
SECRET_KEY = "django-insecure-_8ydzxmco1o-ty@83!y!wky2+*w^v*$abw8ae*lu%lf9z35q)0"
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ("apps.todo.authentication.CustomBearerTokenAuthentication",),
